...
drive_download(as_id("1PxjivIKfqs0nDuSQy-EU_w2Vge6rLoUsuLDfS5r8izI"), type = "csv", overwrite = TRUE)
...
```{r, include=FALSE}
library(meetupr)
meetupr::meetup_auth(httr::oauth2.0_token(httr::oauth_endpoint(authorize = "https://secure.meetup.com/oauth2/authorize", 
            access = "https://secure.meetup.com/oauth2/access"), app = httr::oauth_app("meetup", key = getOption("meetupr.consumer_key"), secret = getOption("meetupr.consumer_secret")), use_oob = FALSE))
...
library(leaflet)
library(ggmap)
ggmap::register_google(Sys.getenv("GOOGLE_MAPS_KEY"))
