...
bind_cols(laocrugs, addresses) %>% 
  ...
  leaflet() %>%
  addProviderTiles(providers$CartoDB.Positron, options = providerTileOptions(minZoom = 7, maxZoom = 7)) %>% 
...
<a href='https://socalrug.slack.com'>
<div class="headers">
<h1>Join us on Slack `r fontawesome::fa("slack", height = "1.8rem", fill = "black")`</h1>
</div>
</a>
