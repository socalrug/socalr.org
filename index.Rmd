...
meetupr::meetup_auth(httr::oauth2.0_token(httr::oauth_endpoint(authorize = "https://secure.meetup.com/oauth2/authorize", 
            access = "https://secure.meetup.com/oauth2/access"), app = httr::oauth_app("meetup", key = getOption("meetupr.consumer_key"), secret = getOption("meetupr.consumer_secret")), scope = "basic"))
