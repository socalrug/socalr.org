---
title: "Welcome!"
subtitle: "<br>Talk 1: Bayesian Analysis with rstan, rstanarm, and brms<br><br>Talk 2: Super speedy data manipulation with data.table: An overview"
output:
...
## ggplot2 and the periodic table
## intro to python via machine learning examples
