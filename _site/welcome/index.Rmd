---
title: "Welcome!"
subtitle: "<br>Talk 1: A Gentle Introduction Using R for Deep Learning<br><br>Talk 2: reticulate: running Python within RStudio"
output:
...
knitr::include_graphics("birthday.png")
```
...
# Sat, Nov. 23
## `r icon::fa("sun")` SoCal R Users All-Hands Meetup
